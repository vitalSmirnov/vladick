  ...
  return (
    ...
    >
      ...
      <div className='max-w-7xl mx-auto relative z-10'>
        <div className='bg-[#FFF6EB] border-2 border-[#33312D] rounded-[32px] p-8 pb-10 md:p-12 lg:p-16 shadow-[0px_12px_0px_0px_#33312D] flex flex-col lg:flex-row gap-12 items-center'>
          {/* Left Content */}
          <div className='scroll-up-card flex-1 flex flex-col gap-8'>
            <div className='scroll-up-text inline-flex items-center gap-2 bg-[#FFE8CA] border border-[#998B79] px-4 py-2 rounded-full w-fit shadow-[0px_2px_0px_0px_#807465]'>
            ...
            <div className='flex flex-col gap-4'>
              <h2 className='scroll-up-title text-4xl md:text-5xl lg:text-6xl font-bold text-[#33312D] tracking-tight leading-tight'>
                {t("referral.titleLine1")} <br className='hidden lg:block' /> {t("referral.titleLine2")}
              </h2>
              <p className='scroll-up-text text-xl md:text-2xl text-[#6E675E] leading-relaxed'>
                {t("referral.subtitle")}
              </p>
            </div>

            {/* Highlight Metric */}
            <div className='scroll-up-card bg-[#33312D] rounded-[24px] p-6 text-[#FFF6EB] transform -rotate-1 hover:rotate-0 transition-transform cursor-default shadow-[0px_8px_0px_0px_rgba(0,0,0,0.2)]'>
            ...
            <ul className='scroll-up-text flex flex-col gap-3 mt-2'>
              {benefits.map((text, i) => (
                <li
                  key={i}
            ...
            <div className='scroll-up-text flex flex-col sm:flex-row gap-4 mt-2'>
              <Button
                variant='red'
                className='flex-1'
              >
          ...
          {/* Right Visual */}
          <div className='flex-1 w-full relative hidden lg:block min-h-[400px] lg:min-h-[500px] flex items-center justify-center mt-8 lg:mt-0'>
            {/* Main image */}
            <div className='scroll-up-card relative z-10 w-full max-w-[400px] aspect-[4/5] rounded-[32px] overflow-hidden border-4 border-[#33312D] shadow-[8px_8px_0px_0px_#FF7F50] bg-[#FFE8CA]'>
              <img
            ...
            <div className='scroll-up-card absolute top-[5%] left-0 lg:-left-12 z-20 bg-white border-2 border-[#33312D] rounded-[24px] p-4 shadow-[4px_4px_0px_0px_#33312D] flex items-center gap-4'>
            ...
            <div className='scroll-up-card absolute bottom-[15%] right-0 lg:-right-12 z-20 bg-white border-2 border-[#33312D] rounded-[24px] p-4 shadow-[4px_4px_0px_0px_#33312D] flex items-center gap-4'>
              <div className='w-12 h-12 bg-[#10A37F]/20 rounded-full flex items-center justify-center text-[#10A37F]'>
                <TrendUpIcon className='w-6 h-6' />
              </div>
              <div>
